#!/bin/bash
################################################################################
# Original Author: André Schenkels, ICTSTUDIO 2014
# Author: Malte Jansen
#-------------------------------------------------------------------------------
#  
...
sudo cp odoo-server.conf /etc/$OE_CONFIG.conf
...
if [ -f ./wkhtmltox-0.12.1_linux-wheezy-amd64.deb ]
then
    echo Use file from hdd
else
    echo Download file
	
	sudo wget http://download.gna.org/wkhtmltopdf/0.12/0.12.1/wkhtmltox-0.12.1_linux-wheezy-amd64.deb -O wkhtmltox-0.12.1_linux-wheezy-amd64.deb
fi
sudo apt-get -f -y install
sudo dpkg -i wkhtmltox-0.12.1_linux-wheezy-amd64.deb

echo "Start Free access to postgreSQL"
